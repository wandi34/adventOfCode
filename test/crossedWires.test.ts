...
describe('Day3 Part1', function() {
  describe('should find shortest direct crossing', function() {
    it('should calc direct path for exercise 1', function() {
      assert.equal(shortestDirectCrossFromStart(test1_w1, test1_w2), result1_part1);
    });

    it('should calc direct path for exercise 2', function() {
      assert.equal(shortestDirectCrossFromStart(test2_w1, test2_w2), result2_part1);
    });
    
    it('should calc direct path for exercise 3', function() {
      assert.equal(shortestDirectCrossFromStart(test3_w1, test3_w2), result3_part1);
    });

    it('should calc direct path for exercise 4', function() {
      assert.equal(shortestDirectCrossFromStart(test4_w1, test4_w2), result4_part1);
    });
    
    it('should return solution for exercise', function() {
      console.log("Solution for exercise3 part1:" + shortestDirectCrossFromStart(exercise_w1, exercise_w2));
    });
  })
});
...
describe('Day3 Part2', function() {
  describe('should find shortest wired crossing', function() {
    it('should calc wired path for exercise 1', function() {
      assert.equal(shortestWiredCrossFromStart(test1_w1, test1_w2), result1_part2);
    });

    it('should calc wired path for exercise 4', function() {
      assert.equal(shortestWiredCrossFromStart(test4_w1, test4_w2), result4_part2);
    });


    it('should calc wired path for exercise 2', function() {
      assert.equal(shortestWiredCrossFromStart(test2_w1, test2_w2), result2_part2);
    });

    it('should calc wired path for exercise 3', function() {
      assert.equal(shortestWiredCrossFromStart(test3_w1, test3_w2), result3_part2);
    });

    it('should return solution for exercise', function() {
      console.log("Solution for exercise3 part2:" + shortestWiredCrossFromStart(exercise_w1, exercise_w2));
    });
  })
});
