...
function crossedWires(wire1, wire2) {
    ...
    var distances = crossedCursors.map(function (c) { return Math.abs(c.x) + Math.abs(c.y); });
    console.log("Distances: " + distances.sort(function (a, b) { return a - b; }));
...
function getSameElements(cursorList1, cursorList2) {
    ...
    for (var _i = 0, cursorList1_1 = cursorList1; _i < cursorList1_1.length; _i++) {
        var cursor = cursorList1_1[_i];
